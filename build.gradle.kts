...
recipeDependencies {
    ...
    testParserClasspath("org.springframework.boot:spring-boot-actuator:2.1.0.RELEASE")
    testParserClasspath("org.springframework.boot:spring-boot-actuator:2.4.+")
    testParserClasspath("org.springframework.boot:spring-boot-actuator:2.5.+")
    ...
    testParserClasspath("org.springframework.boot:spring-boot-starter-actuator:3.0.+")
    testParserClasspath("org.springframework.boot:spring-boot-starter-actuator:3.4.+")
    testParserClasspath("org.springframework.boot:spring-boot-starter-test:2.7.+")
    testParserClasspath("org.springframework.boot:spring-boot-starter-test:3.0.+")
    testParserClasspath("org.springframework.boot:spring-boot-starter-test:3.2.+")
    testParserClasspath("org.springframework.boot:spring-boot-starter-validation:1.5.+")
    testParserClasspath("org.springframework.boot:spring-boot-starter-validation:2.2.+")
    testParserClasspath("org.springframework.boot:spring-boot-starter:2.7.+")
    testParserClasspath("org.springframework.boot:spring-boot-starter:3.0.+")
    testParserClasspath("org.springframework.boot:spring-boot-starter:3.2.+")
    ...
    testParserClasspath("org.springframework.security:spring-security-config:5.7.+")
    testParserClasspath("org.springframework.security:spring-security-config:5.8.+")
    testParserClasspath("org.springframework.security:spring-security-config:6.0.+")
    ...
    testParserClasspath("org.springframework.security:spring-security-ldap:5.5.+")
    testParserClasspath("org.springframework.security:spring-security-ldap:5.7.+")
    testParserClasspath("org.springframework.security:spring-security-ldap:5.8.+")
    testParserClasspath("org.springframework.security:spring-security-ldap:6.0.+")
    testParserClasspath("org.springframework.security:spring-security-oauth2-client:5.5.+")
    testParserClasspath("org.springframework.security:spring-security-oauth2-client:5.8.+")
    testParserClasspath("org.springframework.security:spring-security-oauth2-resource-server:5.5.+")
    ...
    testParserClasspath("org.springframework.security:spring-security-web:5.8.+")
    testParserClasspath("org.springframework.security:spring-security-web:5.8.+")
    testParserClasspath("org.springframework.security:spring-security-web:6.0.+")
    testParserClasspath("org.springframework.security:spring-security-web:6.2.+")

    testParserClasspath("org.springframework:spring-context:5.3.+")
    ...
    testParserClasspath("org.springframework:spring-web:5.3.+")
    testParserClasspath("org.springframework:spring-web:6.0.+")
    testParserClasspath("org.springframework:spring-web:6.1.8")
    testParserClasspath("org.springframework:spring-web:6.2.+")
    testParserClasspath("org.springframework:spring-webflux:5.3.+")
    testParserClasspath("org.springframework:spring-webflux:6.1.16")
    testParserClasspath("org.springframework:spring-webmvc:5.1.+")
    testParserClasspath("org.springframework:spring-webmvc:5.3.+")
    testParserClasspath("org.springframework:spring-webmvc:6.0.+")
}
