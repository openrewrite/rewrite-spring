        ...
        return Preconditions.check(
                ...
                new JavaIsoVisitor<ExecutionContext>() {
                    ...
                    public J.Annotation visitAnnotation(J.Annotation annotation, ExecutionContext ctx) {
                        ...
                        if (HTTP_EXCHANGE_ANNOTATION_MATCHER.matches(a) &&
                                getCursor().getParentOrThrow().getValue() instanceof J.MethodDeclaration) {
                            Optional<J.Assignment> methodArg = findMethodArgument(a);
                            String targetAnnotationClassName = methodArg
                                    .map(this::extractHttpMethod)
                                    .map(this::toExchangeAnnotation)
                                    .orElse(null);
                            ...
                            a = a.withArguments(ListUtils.filter(a.getArguments(), arg -> !methodArg.get().equals(arg)));
                    ...
                    private @Nullable String extractHttpMethod(J.@Nullable Assignment assignment) {
                        if (assignment != null && assignment.getAssignment() instanceof J.Literal) {
                    ...
                    private @Nullable String toExchangeAnnotation(String method) {
                        switch (method) {
                            ...
                            case "PATCH":
                            case "DELETE":
                                return StringUtils.capitalize(method.toLowerCase()) + "Exchange";
                            default:
                                return null;
                        }
                    }
