...
class FindMissingMongoValueRepresentationTest implements RewriteTest {
    ...
    @Test
    void ignoresNonPersistentAndTransientFields() {
        rewriteRun(
          mavenProject("app",
            pomXml(MINIMAL_POM),
            java(
    ...
    @Test
    void reportsValuesNestedInCollections() {
        rewriteRun(
          mavenProject("app",
            pomXml(MINIMAL_POM),
            java(
              ...
              """
                ...
                class Account {
                    ...
                    /*~~(Spring Data MongoDB 5 requires an explicit BigDecimal/BigInteger representation; configure `spring.data.mongodb.representation.big-decimal` or `MongoConverterConfigurationAdapter.bigDecimal(...)`.)~~>*/private List<BigDecimal> balances;
                }
                """
            )
          )
