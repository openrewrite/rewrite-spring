...
class UseSpringBootVersionMavenTest : XmlParser() {
    ...
    fun latestAvailableVersion() {
        assertThat(UseSpringBootVersionMaven("2.+").latestMatchingVersion)
                .isGreaterThanOrEqualTo("2.3.0.RELEASE")

        assertThat(UseSpringBootVersionMaven("2.1.+").latestMatchingVersion)
                .isGreaterThanOrEqualTo("2.1.14.RELEASE")
    }

    @Test
    fun upgradeSpringBootVersion() {
        val useLatestSpringBoot = UseSpringBootVersionMaven("2.+")
